...
# Usage: curl -sL https://raw.githubusercontent.com/vldslvshvchk/MTProxyMaxX/main/install.sh | sudo bash
#
...
#   curl -sL https://raw.githubusercontent.com/vldslvshvchk/MTProxyMaxX/main/install.sh \
#     | sudo MTPROXY_SECRET=000102030405060708090a0b0c0d0e0f MTPROXY_LABEL=alice bash
set -e
SCRIPT_URL="https://raw.githubusercontent.com/vldslvshvchk/MTProxyMaxX/refs/heads/main/mtproxymax.sh"
