...
```bash
sudo bash -c "$(curl -fsSL https://raw.githubusercontent.com/vldslvshvchk/MTProxyMaxX/main/install.sh)"
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/vldslvshvchk/MTProxyMaxX/main/mtproxymax.sh -o mtproxymax
chmod +x mtproxymax
